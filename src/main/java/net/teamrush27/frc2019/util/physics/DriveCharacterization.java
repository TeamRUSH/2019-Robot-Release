...
public class DriveCharacterization {
  ...
  public static CharacterizationConstants characterizeDrive(
      List<VelocityDataPoint> velocityData, List<AccelerationDataPoint> accelerationData) {
  ...
  private static CharacterizationConstants getAccelerationCharacterization(
      double[][] points, CharacterizationConstants velocityChacterization) {
    if (points == null) {
  ...
  private static double[][] getVelocityData(List<VelocityDataPoint> input) {
    ...
    for (int i = 0; i < input.size(); ++i) {
      if (input.get(i).velocity > MathUtils.DEFAULT_MAX_ERROR) {
        if (output == null) {
  ...
  private static double[][] getAccelerationData(
      List<AccelerationDataPoint> input, CharacterizationConstants constants) {
